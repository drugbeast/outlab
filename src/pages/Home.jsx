...
import { POPULAR_GOODS, SLIDER_POTS } from "../constants/constants";
...
function Home() {
  ...
  return (
    <>
      ...
      <Box id="popularGoods" sx={{ paddingTop: "48px" }}>
      ...
      <Box sx={{ paddingTop: "48px" }}>
        <Container maxWidth={false} sx={{ maxWidth: "1888px" }}>
          ...
          <Slider
            contentType="pots"
            slidesPerView={Small ? 1 : 5}
            slidesContent={SLIDER_POTS}
          />
        </Container>
      </Box>
      <Box sx={{ paddingTop: "64px", paddingBottom: "64px" }}>
        <Container maxWidth={false} sx={{ maxWidth: "1888px" }}>
          ...
          <Slider
            ...
            slidesContent={HOME_SLIDER_REVIEWS}
          />
        </Container>
      </Box>
    </>
